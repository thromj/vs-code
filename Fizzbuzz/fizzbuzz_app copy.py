...
regeln = "Geben Sie eine ganze (natürliche) Zahl ein. Wenn diese Zahl durch drei teilbar ist erscheint 'Fizz!', sollte die Zahl durch fünf teilbar sein, erscheint 'Buzz!'. Trifft beides zu erscheint 'FizzBuzz!'."
...
while Count <=10 :                                  #Erstellung eines Loops für die Anzahl der erlaubten Eingaben
    ...
    if f == "Spiel" :                               #Gibt die Regeln aus
        print(regeln, "Viel Spaß beim ausprobieren:")
...
print("Genug für jetzt, schreib lieber eine Kurzbiografie!")        
input("Schließen mit Enter...")